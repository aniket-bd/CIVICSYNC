  ...
  return (
    <div className="glass-card" style={{
      ...
      <div style={{
        ...
        <span style={{
          fontSize: '11px',
          color: riskCollisions.length > 0 ? '#0071e3' : '#1a7f37',
          background: riskCollisions.length > 0 ? 'rgba(0, 113, 227, 0.10)' : 'rgba(48, 209, 88, 0.15)',
          border: riskCollisions.length > 0 ? '1px solid rgba(0, 0, 0, 0.08)' : '1px solid rgba(48, 209, 88, 0.3)',
          padding: '3px 9px',
          borderRadius: '980px',
          fontWeight: 700,
      ...
      <div style={{ flex: 1, padding: '16px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '14px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '10.5px', color: '#0071e3', textTransform: 'uppercase', fontWeight: 700 }}>High Risk Score</div>
            <div style={{ fontSize: '18px', fontWeight: 800, color: '#0071e3', marginTop: '2px', fontFamily: 'SF Mono, ui-monospace, monospace' }}>
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    <AlertTriangle size={15} color={conflict.severity === 'Critical' ? '#ff453a' : '#6e6e73'} />
                    <span style={{
                      fontSize: '11px',
                      fontWeight: 700,
                      color: conflict.severity === 'Critical' ? '#c2411b' : '#0071e3',
                  ...
                  <span style={{
                    fontSize: '10px',
                    fontFamily: 'SF Mono, ui-monospace, monospace',
                    background: conflict.severity === 'Critical' ? 'rgba(254, 242, 240, 0.9)' : 'rgba(255, 255, 255, 0.86)',
                    color: conflict.severity === 'Critical' ? '#c2411b' : '#0071e3',
                    border: conflict.severity === 'Critical' ? '1px solid rgba(194, 65, 27, 0.3)' : '1px solid rgba(0, 0, 0, 0.08)',
                    padding: '2px 7px',
                    borderRadius: '980px',
                    fontWeight: 700
                  }}>
                ...
                <div style={{
                  ...
                  >
                    ...
                    <div style={{ fontSize: '10px', color: '#0071e3', fontWeight: 600 }}>{conflict.projectA.type} ({conflict.projectA.tenderNumber})</div>
                  </div>

                  <ArrowRight size={14} color="#0071e3" style={{ flexShrink: 0 }} />
                  ...
                  >
                    ...
                    <div style={{ fontSize: '10px', color: '#0071e3', fontWeight: 600 }}>{conflict.projectB.type} ({conflict.projectB.tenderNumber})</div>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '11px', color: '#86868b', borderTop: '1px solid rgba(0, 0, 0, 0.05)', paddingTop: '6px' }}>
                  <span>Spatial Proximity: <strong style={{ color: '#0071e3' }}>{conflict.distanceMeters}m</strong></span>
