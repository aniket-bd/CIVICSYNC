    ...
    <div style={{ padding: '32px 40px', display: 'flex', flexDirection: 'column', gap: '24px', minHeight: 'calc(100vh - 56px)' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
        ...
        {sequenceResult && (
          <div className="glass-card" style={{
            ...
            alignItems: 'center',
            gap: '12px',
            boxShadow: '0 4px 16px -2px rgba(255, 149, 0, 0.15)'
          }}>
            <Coins size={20} color="#ff6b00" />
            <div>
              <div style={{ fontSize: '10.5px', color: '#ff6b00', textTransform: 'uppercase', fontWeight: 700, letterSpacing: '0.04em' }}>
                Total Coordinated Municipal Savings
              </div>
              <div style={{ fontSize: '19px', fontWeight: 800, color: '#ff6b00', fontFamily: 'SF Mono, ui-monospace, monospace' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.25fr 1fr', gap: '20px' }}>
        ...
        <div className="glass-card" style={{
          ...
          gap: '14px',
          border: '1.5px solid rgba(255, 149, 0, 0.35)',
          boxShadow: '0 8px 28px -4px rgba(255, 149, 0, 0.12)'
        }}>
          <label style={{ fontSize: '12px', fontWeight: 700, color: '#ff6b00', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '6px', letterSpacing: '0.04em' }}>
            <Layers size={15} color="#ff6b00" /> 1. Select Primary Tender / Corridor
          </label>
          ...
          {primaryProject && (
            <div style={{
              background: 'linear-gradient(135deg, rgba(255, 247, 237, 0.8) 0%, rgba(255, 237, 213, 0.65) 100%)',
              ...
              <div>
                ...
                <div style={{ fontWeight: 700, color: '#ff6b00', marginTop: '2px', fontFamily: 'SF Mono, ui-monospace, monospace' }}>
        ...
        <div className="glass-card" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <label style={{ fontSize: '12px', fontWeight: 700, color: '#ff6b00', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '6px', letterSpacing: '0.04em' }}>
              <Sliders size={15} color="#ff6b00" /> 2. Matching Engine Spatial Parameters
            </label>
            <span style={{ fontSize: '12px', color: '#515154' }}>
              Radius: <strong style={{ color: '#ff6b00', fontWeight: 700 }}>{maxDistanceMeters}m</strong>
            </span>
          </div>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 700,
                      cursor: 'pointer',
                      border: isSelected ? '1px solid rgba(255, 149, 0, 0.6)' : '1px solid rgba(0, 0, 0, 0.08)',
                      background: isSelected ? 'linear-gradient(180deg, #ff7a00 0%, #ff5500 100%)' : 'rgba(255, 255, 255, 0.8)',
                      color: isSelected ? '#ffffff' : '#515154',
                      boxShadow: isSelected ? '0 2px 8px rgba(255, 107, 0, 0.35)' : 'none',
      ...
      {/* ADDITIONAL CANDIDATES LIST (Apple Notes Checkmark Style) */}
            ...
            {otherCandidates.map(c => (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                  {/* Apple Notes Style Circular Checkmark Bullet */}
                  <div style={{
                    width: '22px',
                    height: '22px',
                    borderRadius: '50%',
