    ...
    <div className="glass-card" style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <TrendingUp size={16} color="#0071e3" />
      ...
      <div style={{ flex: 1, padding: '16px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '10.5px', color: '#0071e3', marginTop: '2px', fontWeight: 600 }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '11px', color: '#0071e3', display: 'flex', alignItems: 'center', gap: '4px', fontWeight: 600 }}>
              <TrendingDown size={13} color="#0071e3" />
          ...
          <div style={{
            ...
            <div style={{ fontSize: '11px', color: '#0071e3', display: 'flex', alignItems: 'center', gap: '4px', fontWeight: 700 }}>
              <Coins size={13} color="#0071e3" />
              <span>CivicSync Savings</span>
            </div>
            <div style={{ fontSize: '15.5px', fontWeight: 800, color: '#0071e3', marginTop: '3px', fontFamily: 'SF Mono, ui-monospace, monospace' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <div style={{ fontSize: '11px', color: '#0071e3', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '4px' }}>
          ...
          <div style={{ width: '100%', height: '170px' }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={monthlyData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="rgba(0, 113, 227, 0.08)" />
                ...
                <Bar dataKey="Budget (Cr)" fill="#1d1d1f" radius={[3, 3, 0, 0]} />
                <Bar dataKey="Avoidable Loss" fill="#d2d2d7" radius={[3, 3, 0, 0]} />
                <Bar dataKey="CivicSync Savings" fill="#0071e3" radius={[3, 3, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div style={{
          ...
          <ShieldCheck size={16} color="#0071e3" style={{ flexShrink: 0 }} />
          <span>
            <strong style={{ color: '#0071e3' }}>Deterministic Loss Metric:</strong> 12.5% avoidable municipal loss benchmark is calculated from historical trenching rework, traffic diversion delays, and uncoordinated contractor cuts.
          </span>
        </div>
      </div>
    </div>
