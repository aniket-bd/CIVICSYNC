    ...
    >
      {submittedSuccess ? (
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div>
            <label style={{ fontSize: '12px', color: '#86868b', display: 'block', marginBottom: '4px' }}>Issue Title *</label>
            <input
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
            <div>
              <label style={{ fontSize: '12px', color: '#86868b', display: 'block', marginBottom: '4px' }}>Category</label>
              <select
            ...
            <div>
              <label style={{ fontSize: '12px', color: '#86868b', display: 'block', marginBottom: '4px' }}>Urgency Level</label>
              <select
                className="form-select"
                value={urgency}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
            <div>
              <label style={{ fontSize: '12px', color: '#86868b', display: 'block', marginBottom: '4px' }}>Location / Landmark</label>
              <input
                className="form-input"
                value={locationName}
            ...
            <div>
              <label style={{ fontSize: '12px', color: '#86868b', display: 'block', marginBottom: '4px' }}>Related Tender Project (Optional)</label>
              <select
                className="form-select"
                value={projectId}
          ...
          <div>
            <label style={{ fontSize: '12px', color: '#86868b', display: 'block', marginBottom: '4px' }}>Detailed Description *</label>
            <textarea
